  ...
  <v-row>
    ...
    <v-col cols="6">
      <v-card>
        ...
        <v-card-text>
          <h3>Starting</h3>
          <p>When you open a door, {{this.vehicleName}} powers on the touchscreen and you can operate all controls. To drive {{this.vehicleName}}:
          <ol>
          ...
          <p>Although usually not needed, you can power off {{this.vehicleName}} while sitting in the driver’s seat, provided the vehicle is not moving. Touch <code>Controls > Safety &amp; Security > Power Off</code>. {{this.vehicleName}} automatically powers back on again if you press the brake pedal or touch the touchscreen.</p>
        </v-card-text>
      </v-card>
    </v-col>
    <v-col cols="6">
      <v-card>
        ...
        <v-card-text>
          ...
          <p>To adjust the continuous wiper settings, touch the windshield wiper icon located in the <code>Cards</code> area on the touchscreen.
            <ol>
